/**
 * Floats a composer drawer (command menu, stash menu) above the composer it
 * belongs to. Positioned against the composer's own surface rather than the
 * anchor, so the drawer keeps its width and its 1rem overlap while side panels
 * slide the composer sideways.
 */
