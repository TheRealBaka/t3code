...
/** Browser-playable formats; agents reference them like images: `![demo](out/demo.mp4)`. */
export const WORKSPACE_VIDEO_PREVIEW_EXTENSIONS = [".m4v", ".mov", ".mp4", ".ogv", ".webm"] as const;
